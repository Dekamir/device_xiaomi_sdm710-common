...
package com.lineageos.settings.mipref;
...
import com.lineageos.settings.mipref.R;

public class MiPrefSettings extends PreferenceActivity implements OnPreferenceChangeListener {
	private static final boolean DEBUG = false;
	private static final String TAG = "MiPref";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.mi_settings);
